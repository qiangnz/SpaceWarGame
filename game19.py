...
def draw_init():
    ...
    draw_text(screen, 'Left and Right Arrow Move Plan, Space Shooting', 24, WIDTH/2, HEIGHT/2)
    draw_text(screen, 'Press Any Key to Start Game', 22, WIDTH/2, HEIGHT*3/4)
